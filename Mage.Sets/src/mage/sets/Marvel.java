...
public final class Marvel extends ExpansionSet {
    ...
    private Marvel() {
        super("Marvel the Gathering", "MRV", ExpansionSet.buildDate(2020, 8, 9), SetType.CUSTOM_SET);
...
//        this.ratioBoosterMythic = 8;
        ...
        cards.add(new SetCardInfo("Angel", 7, Rarity.UNCOMMON, mage.cards.a.Angel.class));
        ...
        cards.add(new SetCardInfo("Apocalypse", 281, Rarity.MYTHIC, mage.cards.a.ApocalypseMRV.class));
        ...
        cards.add(new SetCardInfo("Avalanche", 189, Rarity.RARE, mage.cards.a.AvalancheMRV.class)); // Whenever {this} attacks, you may pay any amount of {E}
        ...
        cards.add(new SetCardInfo("Banshee", 9, Rarity.UNCOMMON, mage.cards.b.BansheeMRV.class));
        ...
        cards.add(new SetCardInfo("Baron Zemo", 143, Rarity.UNCOMMON, mage.cards.b.BaronZemo.class));
        cards.add(new SetCardInfo("Battle Van", 393, Rarity.COMMON, mage.cards.b.BattleVan.class));
        cards.add(new SetCardInfo("Baxter Building", 462, Rarity.RARE, mage.cards.b.BaxterBuilding.class));
        ...
        cards.add(new SetCardInfo("Ben Grimm, the Thing", 354, Rarity.RARE, mage.cards.b.BenGrimmTheThing.class));
        cards.add(new SetCardInfo("Betsy Braddock", 80, Rarity.RARE, mage.cards.b.BetsyBraddock.class));
        cards.add(new SetCardInfo("Beyonder", 11, Rarity.MYTHIC, mage.cards.b.Beyonder.class));
        cards.add(new SetCardInfo("Billy Club", 394, Rarity.COMMON, mage.cards.b.BillyClub.class));
        cards.add(new SetCardInfo("Biogenic Upgrade", 239, Rarity.UNCOMMON, mage.cards.b.BiogenicUpgrade.class));
        cards.add(new SetCardInfo("Bionic Limb", 395, Rarity.COMMON, mage.cards.b.BionicLimb.class));
        cards.add(new SetCardInfo("Bishop, the Last X-Man", 284, Rarity.RARE, mage.cards.b.BishopTheLastXMan.class)); // Pay any amount of {E}, {T}:
        cards.add(new SetCardInfo("Black Blade of Muramasa", 396, Rarity.RARE, mage.cards.b.BlackBladeOfMuramasa.class));
        cards.add(new SetCardInfo("Black Bolt, Celestial Messiah", 285, Rarity.UNCOMMON, mage.cards.b.BlackBoltCelestialMessiah.class));
        cards.add(new SetCardInfo("Black Cat", 191, Rarity.RARE, mage.cards.b.BlackCatMRV.class));
        cards.add(new SetCardInfo("Black Market", 144, Rarity.RARE, mage.cards.b.BlackMarket.class));
        cards.add(new SetCardInfo("Black Panther", 13, Rarity.UNCOMMON, mage.cards.b.BlackPanther.class));
        cards.add(new SetCardInfo("Black Tom", 355, Rarity.UNCOMMON, mage.cards.b.BlackTom.class));
        cards.add(new SetCardInfo("Black Widow", 356, Rarity.RARE, mage.cards.b.BlackWidow.class));
        cards.add(new SetCardInfo("Blackbird", 397, Rarity.RARE, mage.cards.b.Blackbird.class));
        cards.add(new SetCardInfo("Blackheart", 145, Rarity.MYTHIC, mage.cards.b.Blackheart.class));
        cards.add(new SetCardInfo("Blade", 357, Rarity.RARE, mage.cards.b.Blade.class));
        cards.add(new SetCardInfo("Blink", 15, Rarity.RARE, mage.cards.b.Blink.class));
        cards.add(new SetCardInfo("Blob", 240, Rarity.UNCOMMON, mage.cards.b.Blob.class)); // WIP - Add protection from infinite loop if two indestructible Blobs damage each other
        cards.add(new SetCardInfo("Book of the Damned", 398, Rarity.RARE, mage.cards.b.BookOfTheDamned.class));
        cards.add(new SetCardInfo("Book of the Vishanti", 399, Rarity.RARE, mage.cards.b.BookOfTheVishanti.class));
        ...
        cards.add(new SetCardInfo("Bruce Banner", 242, Rarity.RARE, mage.cards.b.BruceBanner.class));
        cards.add(new SetCardInfo("Bucky Barnes", 17, Rarity.UNCOMMON, mage.cards.b.BuckyBarnes.class));
        cards.add(new SetCardInfo("Built to Last", 19, Rarity.COMMON, mage.cards.b.BuiltToLast.class));
        cards.add(new SetCardInfo("Bullseye", 286, Rarity.UNCOMMON, mage.cards.b.Bullseye.class));
        cards.add(new SetCardInfo("Cable", 287, Rarity.MYTHIC, mage.cards.c.Cable.class));
        cards.add(new SetCardInfo("Cain Marko", 193, Rarity.RARE, mage.cards.c.CainMarko.class));
        cards.add(new SetCardInfo("Cameron Hodge", 146, Rarity.RARE, mage.cards.c.CameronHodge.class));
        cards.add(new SetCardInfo("Campaign of Vengeance", 288, Rarity.UNCOMMON, mage.cards.c.CampaignOfVengeance.class));
        cards.add(new SetCardInfo("Cannonball", 194, Rarity.UNCOMMON, mage.cards.c.Cannonball.class));
        cards.add(new SetCardInfo("Captain America", 72, Rarity.RARE, mage.cards.c.CaptainAmerica.class));
        cards.add(new SetCardInfo("Carbonadium", 400, Rarity.RARE, mage.cards.c.Carbonadium.class));
        cards.add(new SetCardInfo("Carnage", 147, Rarity.RARE, mage.cards.c.Carnage.class));
        cards.add(new SetCardInfo("Casket of Ancient Winters", 401, Rarity.UNCOMMON, mage.cards.c.CasketOfAncientWinters.class));
        cards.add(new SetCardInfo("Cavorite", 402, Rarity.RARE, mage.cards.c.Cavorite.class));
        cards.add(new SetCardInfo("Cerebro", 82, Rarity.RARE, mage.cards.c.Cerebro.class));
        cards.add(new SetCardInfo("Chameleon", 83, Rarity.RARE, mage.cards.c.Chameleon.class));
        ...
        cards.add(new SetCardInfo("Cloak", 148, Rarity.RARE, mage.cards.c.Cloak.class));
        ...
        cards.add(new SetCardInfo("Dagger", 23, Rarity.UNCOMMON, mage.cards.d.Dagger.class));
        ...
        cards.add(new SetCardInfo("Dazzler", 25, Rarity.UNCOMMON, mage.cards.d.Dazzler.class));
        cards.add(new SetCardInfo("Deathlok", 294, Rarity.COMMON, mage.cards.d.Deathlok.class));
        ...
        cards.add(new SetCardInfo("Doctor Curt Connors", 245, Rarity.UNCOMMON, mage.cards.d.DoctorCurtConnors.class));
        cards.add(new SetCardInfo("Domino", 197, Rarity.UNCOMMON, mage.cards.d.Domino.class));
        cards.add(new SetCardInfo("Drax the Destroyer", 198, Rarity.RARE, mage.cards.d.DraxTheDestroyer.class)); // WIP
        cards.add(new SetCardInfo("Edwin Jarvis", 29, Rarity.UNCOMMON, mage.cards.e.EdwinJarvis.class));
        cards.add(new SetCardInfo("Elektra", 360, Rarity.COMMON, mage.cards.e.Elektra.class));
        ...
        cards.add(new SetCardInfo("Falcon", 300, Rarity.UNCOMMON, mage.cards.f.Falcon.class));
        ...
        cards.add(new SetCardInfo("Firestar", 202, Rarity.UNCOMMON, mage.cards.f.Firestar.class));
        cards.add(new SetCardInfo("First Response", 33, Rarity.UNCOMMON, mage.cards.f.FirstResponse.class));
        cards.add(new SetCardInfo("Forge", 362, Rarity.UNCOMMON, mage.cards.f.Forge.class));
        ...
        cards.add(new SetCardInfo("Gamora", 364, Rarity.UNCOMMON, mage.cards.g.Gamora.class));
        ...
        cards.add(new SetCardInfo("Goblin Glider", 416, Rarity.UNCOMMON, mage.cards.g.GoblinGliderMRV.class));
        ...
        cards.add(new SetCardInfo("Groot", 250, Rarity.RARE, mage.cards.g.Groot.class));
        ...
        cards.add(new SetCardInfo("Guardian", 304, Rarity.UNCOMMON, mage.cards.g.Guardian.class));
        cards.add(new SetCardInfo("Hank Pym", 367, Rarity.RARE, mage.cards.h.HankPym.class));
        cards.add(new SetCardInfo("Havok", 206, Rarity.UNCOMMON, mage.cards.h.Havok.class));
        ...
        cards.add(new SetCardInfo("Hobgoblin", 159, Rarity.UNCOMMON, mage.cards.h.Hobgoblin.class));
        cards.add(new SetCardInfo("Hostile Realm", 208, Rarity.COMMON, mage.cards.h.HostileRealm.class));
        cards.add(new SetCardInfo("Hulk", 242, Rarity.RARE, mage.cards.h.Hulk.class));
        cards.add(new SetCardInfo("Hull Breach", 306, Rarity.COMMON, mage.cards.h.HullBreach.class));
        cards.add(new SetCardInfo("Hydro-Man", 94, Rarity.UNCOMMON, mage.cards.h.HydroMan.class));
        cards.add(new SetCardInfo("Iceman", 95, Rarity.UNCOMMON, mage.cards.i.Iceman.class));
        ...
        cards.add(new SetCardInfo("J. Jonah Jameson", 213, Rarity.COMMON, mage.cards.j.JJonahJameson.class));
        cards.add(new SetCardInfo("James Rhodes", 371, Rarity.UNCOMMON, mage.cards.j.JamesRhodes.class));
        cards.add(new SetCardInfo("Jamie Madrox, the Multiple Man", 99, Rarity.UNCOMMON, mage.cards.j.JamieMadroxTheMultipleMan.class));
        cards.add(new SetCardInfo("Johnny Storm, the Human Torch", 214, Rarity.UNCOMMON, mage.cards.j.JohnnyStormTheHumanTorch.class));
        cards.add(new SetCardInfo("Jubilee", 309, Rarity.UNCOMMON, mage.cards.j.Jubilee.class));
        cards.add(new SetCardInfo("Juggernaut", 193, Rarity.RARE, mage.cards.j.JuggernautMRV.class));
        cards.add(new SetCardInfo("Karma", 102, Rarity.UNCOMMON, mage.cards.k.KaramaMRV.class));
        cards.add(new SetCardInfo("Kill Shot", 41, Rarity.COMMON, mage.cards.k.KillShot.class));
        cards.add(new SetCardInfo("Kraven the Hunter", 255, Rarity.UNCOMMON, mage.cards.k.KravenTheHunter.class));
        cards.add(new SetCardInfo("Lady Deathstrike", 374, Rarity.UNCOMMON, mage.cards.l.LadyDeathstrike.class));
        ...
        cards.add(new SetCardInfo("Luke Cage, Hero for Hire", 375, Rarity.UNCOMMON, mage.cards.l.LukeCageHeroForHire.class));
        cards.add(new SetCardInfo("Magneto's Helmet", 424, Rarity.COMMON, mage.cards.m.MagnetosHelmet.class));
        cards.add(new SetCardInfo("Malfunction", 108, Rarity.COMMON, mage.cards.m.Malfunction.class));
        cards.add(new SetCardInfo("Mantis, Celestial Madonna", 256, Rarity.UNCOMMON, mage.cards.m.MantisCelestialMadonna.class));
        cards.add(new SetCardInfo("Mark for Death", 217, Rarity.UNCOMMON, mage.cards.m.MarkForDeath.class));
        cards.add(new SetCardInfo("Marrow", 376, Rarity.UNCOMMON, mage.cards.m.Marrow.class));
        cards.add(new SetCardInfo("Mary Jane Watson", 43, Rarity.COMMON, mage.cards.m.MaryJaneWatson.class));
        ...
        cards.add(new SetCardInfo("Morbius", 379, Rarity.UNCOMMON, mage.cards.m.Morbius.class));
        cards.add(new SetCardInfo("Murder Investigation", 49, Rarity.UNCOMMON, mage.cards.m.MurderInvestigation.class));
        cards.add(new SetCardInfo("Mysterio", 112, Rarity.UNCOMMON, mage.cards.m.Mysterio.class));
        ...
        cards.add(new SetCardInfo("Mystique", 380, Rarity.UNCOMMON, mage.cards.m.Mystique.class));
        ...
        cards.add(new SetCardInfo("Nighthawk", 381, Rarity.COMMON, mage.cards.n.Nighthawk.class));
        ...
        cards.add(new SetCardInfo("Northstar", 321, Rarity.UNCOMMON, mage.cards.n.Northstar.class));
        cards.add(new SetCardInfo("Omega Red", 322, Rarity.UNCOMMON, mage.cards.o.OmegaRed.class));
        ...
        cards.add(new SetCardInfo("Peter Quill", 220, Rarity.UNCOMMON, mage.cards.p.PeterQuill.class));
        ...
        cards.add(new SetCardInfo("Prowler", 383, Rarity.COMMON, mage.cards.p.Prowler.class));
        cards.add(new SetCardInfo("Psylocke", 80, Rarity.RARE, mage.cards.p.Psylocke.class));
        cards.add(new SetCardInfo("Puck", 264, Rarity.COMMON, mage.cards.p.Puck.class));
        cards.add(new SetCardInfo("Putrefy", 327, Rarity.UNCOMMON, mage.cards.p.Putrefy.class));
        cards.add(new SetCardInfo("Pyro", 223, Rarity.UNCOMMON, mage.cards.p.Pyro.class));
        cards.add(new SetCardInfo("Raise the Alarm", 59, Rarity.COMMON, mage.cards.r.RaiseTheAlarm.class));
        cards.add(new SetCardInfo("Rahne Sinclair", 230, Rarity.COMMON, mage.cards.r.RahneSinclair.class));
        ...
        cards.add(new SetCardInfo("Rhino", 268, Rarity.COMMON, mage.cards.r.Rhino.class));
        cards.add(new SetCardInfo("Rhythm of the Wild", 329, Rarity.UNCOMMON, mage.cards.r.RhythmOfTheWild.class));
        cards.add(new SetCardInfo("Rictor", 384, Rarity.COMMON, mage.cards.r.Rictor.class));
        ...
        cards.add(new SetCardInfo("Rocket Raccoon", 226, Rarity.COMMON, mage.cards.r.RocketRaccoon.class));
        cards.add(new SetCardInfo("Ruby-Quartz Visor", 437, Rarity.COMMON, mage.cards.r.RubyQuartzVisor.class));
        cards.add(new SetCardInfo("Salvaging Station", 439, Rarity.RARE, mage.cards.s.SalvagingStation.class));
        cards.add(new SetCardInfo("Sandman", 227, Rarity.UNCOMMON, mage.cards.s.Sandman.class));
        ...
        cards.add(new SetCardInfo("Shocker", 230, Rarity.UNCOMMON, mage.cards.s.ShockerMRV.class));
        ...
        cards.add(new SetCardInfo("Spider-Mobile", 444, Rarity.COMMON, mage.cards.s.SpiderMobile.class));
        ...
        cards.add(new SetCardInfo("Starlord", 220, Rarity.UNCOMMON, mage.cards.s.Starlord.class));
        ...
        cards.add(new SetCardInfo("Steve Rogers", 72, Rarity.RARE, mage.cards.s.SteveRogers.class));
        ...
        cards.add(new SetCardInfo("Sue Storm, the Invisible Woman", 130, Rarity.UNCOMMON, mage.cards.s.SueStormTheInvisibleWoman.class));
        ...
        cards.add(new SetCardInfo("Thanos, the Mad Titan", 177, Rarity.MYTHIC, mage.cards.t.ThanosTheMadTitan.class));
        cards.add(new SetCardInfo("The Lizard", 245, Rarity.UNCOMMON, mage.cards.t.TheLizard.class));
        ...
        cards.add(new SetCardInfo("Toad", 275, Rarity.COMMON, mage.cards.t.Toad.class));
        ...
        cards.add(new SetCardInfo("War Machine", 371, Rarity.UNCOMMON, mage.cards.w.WarMachine.class));
        cards.add(new SetCardInfo("Warlock", 138, Rarity.UNCOMMON, mage.cards.w.Warlock.class));
        cards.add(new SetCardInfo("Warpath", 236, Rarity.UNCOMMON, mage.cards.w.WarpathMRV.class));
        cards.add(new SetCardInfo("Weapon Rack", 458, Rarity.COMMON, mage.cards.w.WeaponRack.class));
        cards.add(new SetCardInfo("Wolfsbane", 265, Rarity.COMMON, mage.cards.w.Wolfsbane.class));
        cards.add(new SetCardInfo("Wong", 77, Rarity.COMMON, mage.cards.w.Wong.class));
