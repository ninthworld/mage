 ...
 * @author NinthWorld
 */
public final class ApocalypseMRV extends CardImpl {
    ...
    public ApocalypseMRV(UUID ownerId, CardSetInfo setInfo) {
    ...
    public ApocalypseMRV(final ApocalypseMRV card) {
        super(card);
    }

    @Override
    public ApocalypseMRV copy() {
        return new ApocalypseMRV(this);
    }
}
