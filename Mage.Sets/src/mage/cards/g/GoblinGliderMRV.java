 ...
 * @author NinthWorld
 */
public final class GoblinGliderMRV extends CardImpl {

    public GoblinGliderMRV(UUID ownerId, CardSetInfo setInfo) {
    ...
    public GoblinGliderMRV(final GoblinGliderMRV card) {
        super(card);
    }

    @Override
    public GoblinGliderMRV copy() {
        return new GoblinGliderMRV(this);
    }
}
